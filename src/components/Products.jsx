...
const Products = () => {
  return <div>
    <div className='bg-[#131313] w-[984px] p-[20px] rounded-[15px] text-[#fff]'>
      <div className='bg-[#232323] w-[210px] h-[150px] pl-[12px] pr-[15px] rounded-[4.68775px]'>
       <div className='flex justify-between items-center'>
       <div><img src={rectangle} alt="" className='pt-[10px] w-[70px]rn'/></div>
        <div className='space-y-2 pt-[13px]'>
          ...
          <p className='text-[16px]'>$ <span className='text-[13px]'>29.99</span></p>
        </div>
       </div>
      ...
      <div className='text-xs opacity-[0.6] pt-[6px]'>Description of the Product/Item</div>
      </div>
    </div>
  </div>;
};
